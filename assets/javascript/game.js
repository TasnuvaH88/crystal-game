$(document).ready(function() {
  ...
  function randomNumCrystals() {
    ...
    return {
      ...
      magenta: {
        points: Math.floor(Math.random() * 12) + 1,
        imageUrl: "assets/images/magenta.png"
      },
      orange: {
        points: Math.floor(Math.random() * 12) + 1,
  ...
  function updateDom(didUserWin) {
    ...
    if (didUserWin === true) {
      ...
      $("#statement").append($("<p>").text("You won! (^_^)!!!!"));
      setGame();
    ...
    // If the user lost...
      ...
      $("#statement").append($("<p>").text("You lost! (U_U)..!"));
      setGame();
      renderMatchingNumber();
    }
    ...
    $("#statement").append(pWins);
    $("#statement").append(pLosses);
  }
  ...
  function renderCrystals() {
    for (var key in crystals) {
      ...
      $("#crystal-display").append(crystalDiv);
    }
  }
